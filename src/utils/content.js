...
// Bvent Section
import stockImg from "../assets/images/bventImg/inv-img.png";
...
export const bventSection = { Items: {
    ...
    subtitle: "Inventory system to control and manage products in the warehouse in real time and to make it easier to develop your business",
    stockImg,
  }
}
...
export const section2Content = {
  items: [
    { counter: 15, after: "K", subtitle: "Brand Owners" },
    { counter: 345, after: "+", subtitle: "Partner" },
    { counter: 4.4, after: "M+", subtitle: "Total Stock", decimals: true },
...
export const section4Content = {
  ...
  bottom: {
    title: "Bvent Inventory Ecosystem",
    TABS: [
      {
        name: "Buy",
        image: Phone1Img,
...
export const section9Content = {
  title: "Here is what our clients has to say",
  ITEMS: [
    {
      title: "Denzi Ltd",
      subtitle:
        "This applictaion does what it says and even more, it has increase my productivity by 60%.",
      image: user01,
    },
    {
      title: "Victoria Renz",
      subtitle:
        "Bven is highly recommended to start up, it makes you track you stock effectively.",
      image: user02,
    },
  ],
};
...
export const footerContent = {
  ...
  copyright: {
    left: "© 2023 Bvent, All Rights Reserved.",
    center: "ENS: bvent.App",
    right: "BUIDL @bvent.app 2019",
  },
};
